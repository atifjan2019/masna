...
export const metadata = {
  ...
  description:
    "24/7 Mobile Tyre Fitting in United Kingdom & outskirts. Emergency roadside assistance, ETA from 20 mins. Brand new tyres, TPMS & puncture repair. Call 0788 328 8831 now.",
};
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        <Script id="gtm-init-2" strategy="beforeInteractive">
          {`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-NWW9SMQG');`}
        </Script>
        <meta charSet="UTF-8" />
        ...
        <script dangerouslySetInnerHTML={{
          __html: `
            ...
            })(window, document, "clarity", "script", "wpk5e43w88");
          `
        }} />
      </head>
      <body suppressHydrationWarning>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-NWW9SMQG"
            height="0"
            width="0"
            style={{ display: "none", visibility: "hidden" }}
          />
