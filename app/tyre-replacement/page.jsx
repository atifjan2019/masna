...
import TyreReplacement from "components/TyreReplacement";
...
export default async function TyreReplacementPage({ searchParams }) {
    const params = await searchParams;
    const locationName = params?.loc ? sanitizeLocation(params.loc, getLocations()) : null;
    return <main><TyreReplacement locationName={locationName} /></main>;
}
